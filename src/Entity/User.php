...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Announce::class, mappedBy="users")
     */
    private $announce;
    ...
    {
        if ($this->announce->removeElement($announce)) {
            // set the owning side to null (unless already changed)
            if ($announce->getUsers() === $this) {
                $announce->setUsers(null);
            }
        }
